# Documentation License – OHM Smart Contracts Repository
...
(for example, design notes, specs, and explanatory READMEs) is licensed under the
...
If a specific document or asset in this repository uses a different license,
that will be clearly indicated in that file.
